        ...
        private void desp_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (desp.SelectedIndex >= 0)
            {
                ...
                if (pfound != null)
                {
                    ...
                    {
                        nation.Source = new BitmapImage(new Uri("ms-appx:///Assets//correct.png"));
                    ...
                    {
                        team.Source = new BitmapImage(new Uri("ms-appx:///Assets//correct.png"));
                        img_team.Source = new BitmapImage(new Uri(player.club_logo));
                    }
                    if (pfound.position.Equals(player.position))
                    {
                        position.Source = new BitmapImage(new Uri("ms-appx:///Assets//correct.png"));
                    ...
                    {
                        age.Source = new BitmapImage(new Uri("ms-appx:///Assets//correct.png"));
                ...
                desp.Items.Clear();
                textBoxes[ntry++].Text = pfound.name;
                if (ntry == 6)
                {
